...
<QuizComponent quizId="select" quizItems={
[
    {
        "item_type": "radio",
        "question": "FROM 절에 명시된 테이블의 모든 열(컬럼)을 조회하고자 할 때, SELECT 절에 사용하는 기호는 무엇인가요?",
        "options": [
            "%",
            "&",
            "*",
        ...
        "hint": "흔히 '별표' 또는 '아스타리스크'라고 부르는 기호입니다.",
        "solution": "*"
    },
    {
        "item_type": "radio",
        "question": "SELECT 문으로 조회한 열의 이름을 더 이해하기 쉬운 다른 이름으로 표시하고 싶을 때 사용하는 키워드는 무엇인가요?",
        "options": [
            "RENAME",
            "ALIAS",
            "COLUMN",
        ...
        "hint": "별칭(Alias)을 지정할 때 사용하는 전치사입니다.",
        "solution": "AS"
    },
    {
        "item_type": "radio",
        "question": "다음 SQL 문은 어떤 테이블의 내용을 조회하는 것입니까? SELECT EVAL_DT, CREDIT_GRADE FROM TB_CREDIT_INFO;",
        "options": [
            "EVAL_DT",
            "CREDIT_GRADE",
            "TB_CREDIT_INFO"
        ],
        "hint": "데이터를 가져올 대상 테이블은 FROM 절 뒤에 명시됩니다.",
        "solution": "TB_CREDIT_INFO"
    },
    {
        "item_type": "checkbox",
        "question": "위의 SQL 문(SELECT EVAL_DT, CREDIT_GRADE FROM TB_CREDIT_INFO;)이 조회하는 컬럼을 모두 선택하세요.",
        "options": [
            "EVAL_DT",
            "CREDIT_GRADE",
            "TB_CREDIT_INFO"
        ],
        "hint": "SELECT 절 뒤에 나열된 항목들이 조회되는 컬럼입니다.",
        "solution": [
            "EVAL_DT",
            "CREDIT_GRADE"
        ]
    ...
    {
        "item_type": "checkbox",
        "question": "SQL의 주석에 대한 설명 중 올바른 것을 모두 고르세요.",
        "options": [
            "-- 로 한 줄 주석을 작성할 수 있다",
            "/* 와 */ 로 여러 줄 주석을 작성할 수 있다",
            "주석은 코드에 대한 설명을 작성할 때 사용된다"
        ],
        "hint": "SQL은 한 줄 주석과 블록 주석을 모두 지원하며, 주석은 코드 설명에 활용됩니다.",
        "solution": [
            "-- 로 한 줄 주석을 작성할 수 있다",
            "/* 와 */ 로 여러 줄 주석을 작성할 수 있다",
            "주석은 코드에 대한 설명을 작성할 때 사용된다"
    ...
    {/* {
        "item_type": "short",
        "question": "Oracle에서 특정 테이블을 조회하지 않는 SELECT 문을 작성할 때 사용하는 가상의 테이블 이름은?",
        "hint": "컬럼 하나, 행 하나만 존재하는 더미 테이블입니다.",
        "solution": "DUAL"
    } */}
]
} />
