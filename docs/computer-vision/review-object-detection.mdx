...
[
    ...
    },
    {
        ...
        "options": [
            "m은 모든 종류의 물체에 대한 평균을 나타낸다",
            "AP는 모든 Recall에 대한 Precision의 평균한 것임을 나타낸다",
            "50-95는 IOU 임계값이 0.5일 때와 0.95일 때의 차이를 나타낸다"
        ],
    ...
    {
        "item_type": "radio",
        "question": "YOLO 모델을 쉽게 사용할 수 있는 라이브러리의 이름은 무엇입니까?",
        "options": [
            "pytorch",
            "keras",
            "tensorflow",
        ...
        "hint": "Ultralytics는 YOLO 모델의 구현과 사용을 간편하게 해주는 라이브러리입니다.",
        "solution": "ultralytics"
    },
]    
} />
