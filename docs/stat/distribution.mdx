...
<QuizComponent quizId="distribution" quizItems={[
    ...
    {
        item_type: 'number',
        question: 'hr.xlsx에서 overtime의 값이 20일 때 이를 표준화한 값(Z-score)을 구해보세요',
