...
<iframe src="https://tally.so/embed/31RjML?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1" loading="lazy" width="100%" height="2449" frameborder="0" marginheight="0" marginwidth="0" title="[통계] 변수의 변형"></iframe>
